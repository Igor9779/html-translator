// src/pages/HtmlTranslatorPage.jsx
...
export default function HtmlTranslatorPage() {
  ...
  return (
    <>
      ...
      <textarea
        rows={4}
        className="w-full p-3 border border-gray-300 dark:border-gray-700 rounded-md font-mono focus:outline-none focus:ring-2 focus:ring-blue-500 transition dark:bg-gray-800 dark:text-gray-100"
        value={inputHtml}
      ...
      <pre className="border border-gray-300 dark:border-gray-700 rounded-md bg-gray-100 dark:bg-gray-800 p-4 whitespace-pre-wrap font-mono text-sm">
        {translatedHtml}
      </pre>
